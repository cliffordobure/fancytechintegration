...
if (!hasCloudinaryConfig) {
  ...
  const uploadToCloudinary = (buffer, folder = 'fancytech-kenya') => {
  ...
  router.post('/', protect, admin, uploadMemory.single('image'), async (req, res) => {
  ...
  // @access  Private/Admin
  router.post('/multiple', protect, admin, uploadMemory.array('images', 10), async (req, res) => {
